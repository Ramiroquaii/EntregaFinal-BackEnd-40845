  ...
  fetch('/api/productos')
    ...
    .then(data => {
      ...
      data.forEach(element => {
        ...
        <button class="btn btn-success" id="btn-addPrd" data-indice="${element._id}" onclick="addProductToChart('${element._id}')">+</button>
        <button class="btn btn-success" id="btn-delPrd" data-indice="${element._id}" onclick="removeProductFromChart('${element._id}')">-</button>
        </div>`;
      });
